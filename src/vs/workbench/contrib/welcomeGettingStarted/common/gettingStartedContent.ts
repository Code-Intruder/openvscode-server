...
// CUSTOM: Deshabilitado import de product ya que solo se usaba para defaultChat
...
// CUSTOM: Deshabilitado defaultChat ya que solo se usaba para copilotSettingsMessage
/* const defaultChat = {
...
// CUSTOM: Deshabilitado mensaje de configuración de Copilot
...
// CUSTOM: Deshabilitadas constantes y funciones de Copilot
...
export const walkthroughs: GettingStartedWalkthroughContent = [
	{
		...
		content: {
			type: 'steps',
			steps: [
				// CUSTOM: Deshabilitados pasos de configuración de Copilot
